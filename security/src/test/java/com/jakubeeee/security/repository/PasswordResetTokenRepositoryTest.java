...
public class PasswordResetTokenRepositoryTest {
    ...
    public void setUpForEveryTest() {
        ...
        testPasswordResetToken1 = new PasswordResetToken("testValue1", testUser, getCurrentDateTime(), 120);
        entityManager.persist(testPasswordResetToken1);
        testPasswordResetToken2 = new PasswordResetToken("testValue2", testUser, getCurrentDateTime(), 120);
        entityManager.persist(testPasswordResetToken2);
        testPasswordResetToken3 = new PasswordResetToken("testValue3", testUser, getCurrentDateTime(), 120);
        entityManager.persist(testPasswordResetToken3);
    }

    @Test
    public void saveTest_shouldSave() {
        var savedEntity = new PasswordResetToken("anotherTestValue", testUser, getCurrentDateTime(), 120);
    ...
    public void saveTest_nonUniqueValue_shouldThrowException() {
        var savedEntity1 = new PasswordResetToken("nonUniqueTestValue", testUser, getCurrentDateTime(), 120);
        repository.save(savedEntity1);
        var savedEntity2 = new PasswordResetToken("nonUniqueTestValue", testUser, getCurrentDateTime(), 120);
        repository.save(savedEntity2);
    }

    @Test(expected = DataAccessException.class)
    public void saveTest_nullValue_shouldThrowException() {
        var savedEntity = new PasswordResetToken(null, testUser, getCurrentDateTime(), 120);
        repository.save(savedEntity);
    }
    ...
    public void saveTest_nullExpiryDate_shouldThrowException() {
        var savedEntity = new PasswordResetToken("anotherTestValue", testUser, null, 120);
        repository.save(savedEntity);
    }

    @Test
    public void saveAllTest_shouldSave() {
        var savedEntity1 = new PasswordResetToken("anotherTestValue1", testUser, getCurrentDateTime(), 120);
        var savedEntity2 = new PasswordResetToken("anotherTestValue2", testUser, getCurrentDateTime(), 120);
        var savedEntity3 = new PasswordResetToken("anotherTestValue3", testUser, getCurrentDateTime(), 120);
